...
import WaiterNavbar from "../components/WaiterNavbar"; // Use role-specific navbar
    ...
    return (
        ...
        <div className="waiter-screen">
            <div className="waiter-header">
                <h1 className="waiter-title">🍽️ Waiter Live Screen</h1>
                ...
                {Object.keys(groupedOrders).length === 0 && (
                    <div className="no-orders">
                        <div className="no-orders-content">
                            ...
                            <p>Prepaired orders will appear here when ready.</p>
                        </div>
                    </div>
                )}
            </div>
